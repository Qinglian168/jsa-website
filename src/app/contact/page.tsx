        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-primary-light border border-blue-100 rounded-lg flex items-center justify-center shrink-0">
              ...
              <div className="bg-primary-light/50 border border-blue-100 rounded-2xl p-6">
